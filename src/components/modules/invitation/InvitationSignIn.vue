<template>
  <div class="w-full max-w-lg p-6 space-y-4 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
    <div>
      <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Log in to continue</h2>
