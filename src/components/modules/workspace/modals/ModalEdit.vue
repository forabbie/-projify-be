    ...
    <div class="relative w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="px-6 py-6 lg:px-8">
          <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Workspace Update</h3>
          <vee-form class="mt-8 space-y-6" :validation-schema="schema" @submit="onsave">
            ...
            <FieldInputGroup>
              <template #label>
                <FieldInputLabel label="Name" label_for="input-workspace-name" />
              </template>
              <template #field>
                <FieldInput
                  :data="data.name"
              ...
              <template #error>
                <ErrorMessage class="text-red-600" name="workspace-name" />
              </template>
            </FieldInputGroup>
            ...
            <FieldInputGroup>
              <template #label>
                <FieldInputLabel
                  ...
                  label_for="input-workspace-description"
                />
              </template>
              <template #field>
                <FieldInput
                  ...
                  id="input-workspace-description"
                  placeholder=""
              ...
              <template #error>
                <ErrorMessage class="text-red-600" name="workspace-description" />
              </template>
            </FieldInputGroup>
...
// const workspace = ref(props.data)
